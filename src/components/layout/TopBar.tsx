...
import { Moon, Sun, Wifi, WifiOff, AlertTriangle } from "lucide-react";
...
export function TopBar() {
  ...
  return (
    <header className="sticky top-0 z-20 w-full bg-surface-bg/95 backdrop-blur border-b border-surface-border safe-pt">
